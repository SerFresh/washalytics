...
//                 <div className="profilecontrent">
//                     <img className='profile' src={profile.Photo} alt="Profile" />
//                 </div>
//                 <h2>{profile.Owner_name}</h2>
//                 <p>{profile.Laundry_name}</p>
//             </header>
...
//             <main>
//                 <h2>Email</h2>
//                 <div className='blue-border'><p>{profile.email}</p></div>
                
//                 <h2>Tel</h2>
//                 <div className='blue-border'><p>{profile.telephone}</p></div>
                
//                 <h2>Address</h2>
//                 <div className='blue-border'><p>{profile.address}</p></div>
