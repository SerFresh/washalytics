...
const Home = ({ Review, Machine, Profile }) => {
    ...
    const handleAddMachine = () => {
        ...
        if (!customerId) {
            console.error("❌ No CustomerID found! Please log in.");
        ...
        const newMachine = {
            MachineName: "New Washer",  // 🛠 เปลี่ยนเป็นค่าจริงจาก Form หรือ Modal ก็ได้
            Times: 0,                    // เครื่องใหม่ตั้งค่าเริ่มต้น
            CustomerID: customerId        // เชื่อมกับลูกค้าปัจจุบัน
        };
    
        axios.post(`http://localhost:8000/api/add_machine/${customerId}/`, newMachine)
            .then(response => {
                ...
                <div className='blue-blox block-money'>
                    ...
                    <div>
                        <div className='line-machine'>
                            <h2>Machine</h2>
                            <div onClick={handleAddMachine} className='add-machine'>
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11 1.66669V20.3334M1.66663 11H20.3333" 
                                        stroke="#29B6F6" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                            </div>
                        </div>
